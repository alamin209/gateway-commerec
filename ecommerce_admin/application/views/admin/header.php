            ...
            <ul class="nav top-menu">
                ...
                <li id="header_inbox_bar" class="dropdown">
                    ...
                    <ul class="dropdown-menu extended inbox">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo"><img alt="avatar" src="<?= base_url('assets/admin/')?>images/1.png"></span>
                                <span class="subject">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo"><img alt="avatar" src="<?= base_url('assets/admin/')?>images/3.png"></span>
                                <span class="subject">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo"><img alt="avatar" src="<?= base_url('assets/admin/')?>images/2.png"></span>
                                <span class="subject">
